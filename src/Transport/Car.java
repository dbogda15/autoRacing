...
public enum BodyType {
    ...
    public boolean equals(Object o) {
        ...
        Car<?> car = (Car<?>) o;
        return Objects.equals(driver, car.driver) && bodyType == car.bodyType && Objects.equals(mechanic, car.mechanic);
    }

    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), driver, bodyType, mechanic);
    }
}
